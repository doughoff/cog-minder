...
})({"1yi0L":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "7d696a087e31a8c2ccfc86dc8b410099";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH */
...
},{}],"35ocY":[function(require,module,exports) {
...
jq(function ($) {
  ...
  const noneHiddenCategories = ["categoryAlien", "categoryTesting", "categoryGolem", "categorySpoiler", "categoryRedacted"].map(id => categoryIdMap[id]);
  ...
  function createItems() {
    const items = Object.values(_commonJs.itemData);
    const itemsGrid = $("#itemsGrid");
    items.forEach(item => {
      const itemName = item["Name"];
      const itemId = _commonJs.nameToId(itemName);
      const element = $(`<button
                    id="${itemId}"
                    class="item btn"
                    type="button"
                    data-html=true
                    data-content='${_commonJs.createItemDataContent(item)}'
                    data-toggle="popover">
                    ${itemName}
                 </button>`);
  ...
  function getItemFilter() {
    ...
    if (spoilersState === "None") {
      filters.push(item => !_commonJs.getItemCategories(item["Name"]).some(c => noneHiddenCategories.includes(c)));
    } else if (spoilersState === "Spoilers") {
      filters.push(item => !_commonJs.getItemCategories(item["Name"]).some(c => spoilerHiddenCategories.includes(c)));
    }
    // Name filter
    ...
    if ((categoryId in categoryIdMap)) {
      ...
      filters.push(item => _commonJs.getItemCategories(item["Name"]).includes(filterNum));
    }
  ...
  function resetFilters() {
    ...
    $("#mass").val("");
    // Reset buttons
    _commonJs.resetButtonGroup($("#schematicsContainer"));
    _commonJs.resetButtonGroup($("#slotsContainer"));
    _commonJs.resetButtonGroup($("#powerTypeContainer"));
    _commonJs.resetButtonGroup($("#propTypeContainer"));
    _commonJs.resetButtonGroup($("#utilTypeContainer"));
    _commonJs.resetButtonGroup($("#weaponTypeContainer"));
    _commonJs.resetButtonGroup($("#categoryContainer"));
    // Reset sort
  ...
  function sortItemNames(itemNames) {
    ...
    itemNames.sort((a, b) => {
      const itemA = _commonJs.getItem(a);
      const itemB = _commonJs.getItem(b);
    ...
    itemNames.forEach(itemName => {
      const item = _commonJs.getItem(itemName);
  ...
  function updateItems() {
    ...
    let items = [];
    Object.keys(_commonJs.itemData).forEach(itemName => {
      const item = _commonJs.getItem(itemName);
      if (itemFilter(item)) {
...
},{}],"7ojxO":[function(require,module,exports) {
var define;
/*!
...
},{}]},{},["1yi0L","35ocY"], "35ocY", "parcelRequire5d10")

//# sourceMappingURL=parts.8b410099.js.map
