...
})({"5lNeS":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "b9f6c8263496cbc73a1bbb2ad8d2432f";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH */
...
},{}],"141Q9":[function(require,module,exports) {
var define;
/*!
* Chart.js v2.9.4
...
!(function (t, e) {
  ...
  var ge, pe = {
    ...
    update: function (t, e, n) {
      if (t) {
        var i = t.options.layout || ({}), a = H.options.toPadding(i.padding), r = e - a.width, o = n - a.height, s = (function (t) {
          var e = (function (t) {
            var e, n, i, a = [];
  ...
  var hi = yn.extend({
    ...
    tickFormatFunction: function (t, e, n, i) {
      var a = this._adapter, r = this.options, o = r.time.displayFormats, s = o[this._unit], l = this._majorUnit, u = o[l], d = n[e], h = r.ticks, c = l && u && d && d.major, f = a.format(t, i || (c ? u : s)), g = c ? h.major : h.minor, p = $n([g.callback, g.userCallback, h.callback, h.userCallback]);
      return p ? p(f, e, n) : f;
    },
    ...
    getLabelCapacity: function (t) {
      var e = this, n = e.options.time, i = n.displayFormats, a = i[n.unit] || i.millisecond, r = e.tickFormatFunction(t, 0, di(e, [t], e._majorUnit), a), o = e._getLabelSize(r), s = Math.floor(e.isHorizontal() ? e.width / o.w : e.height / o.h);
  ...
  var Ai = K.extend({
    ...
    beforeFit: Si,
    fit: function () {
      var t = this, e = t.options, n = e.labels, i = e.display, a = t.ctx, r = H.options._parseFont(n), o = r.size, s = t.legendHitBoxes = [], l = t.minSize, u = t.isHorizontal();
    ...
    draw: function () {
      var t = this, e = t.options, n = e.labels, i = N.global, a = i.defaultColor, r = i.elements.line, o = t.height, s = t.columnHeights, l = t.width, u = t.lineWidths;
      if (e.display) {
  ...
  for (var Bi in (Li.filler = Ri, Li.legend = zi, Li.title = Ni, en.helpers = H, (function () {
    ...
    function n(n, i, a) {
      var r = document.defaultView, o = H._getParentNode(n), s = r.getComputedStyle(n)[i], l = r.getComputedStyle(o)[i], u = e(s), d = e(l), h = Number.POSITIVE_INFINITY;
...
},{}]},{},["5lNeS","141Q9"], "141Q9", "parcelRequire5d10")

//# sourceMappingURL=simulator.d8d2432f.js.map
