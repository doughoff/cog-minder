...
})({"2vvb9":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "b5feb7d79af6b6266c4d4727731d3286";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH */
...
},{}],"2WG0Q":[function(require,module,exports) {
var define;
/*!
...
!(function (e, t) {
  ...
  !(function (z) {
    ...
    var d = ["sanitize", "whiteList", "sanitizeFn"], r = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], e = {
      ...
      u: [],
      ul: []
    }, l = /^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|$))/gi, a = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i;
    function v(e, t) {
    ...
    var C = {
      ...
      104: "8",
      105: "9"
    }, N = 27, D = 13, H = 32, W = 9, B = 38, M = 40, R = {
      success: !1,
      major: "3"
    };
    try {
...
},{"jquery":"7ojxO"}]},{},["2vvb9","2WG0Q"], "2WG0Q", "parcelRequire5d10")

//# sourceMappingURL=simulator.731d3286.js.map
